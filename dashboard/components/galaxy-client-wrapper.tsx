...
export default function GalaxyClientWrapper() {
    ...
    const flatFiles = status.result.static || [];
    const fusionReports = status.result.reports || [];
    const allBugs = status.result.bugs || [];
